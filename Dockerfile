# ------------------------------------------------------------
# Basis‑Image (SQL Server 2022 Developer – aktuell das einzige verfügbare)
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# Microsoft‑Key & das **richtige** Repository für Ubuntu 20.04 einbinden
# ------------------------------------------------------------
RUN curl -sSL https://packages.microsoft.com/keys/microsoft.asc | apt-key add - && \
    curl -sSL https://packages.microsoft.com/config/ubuntu/20.04/mssql-server-2022.list \
